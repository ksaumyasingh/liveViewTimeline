defmodule Chrip.TimelineTest do
  use Chrip.DataCase

  alias Chrip.Timeline

  describe "posts" do
    alias Chrip.Timeline.Post

    import Chrip.TimelineFixtures
    ...
    test "create_post/1 with valid data creates a post" do
      valid_attrs = %{body: "some body", likes: "some likes", username: "some username"}

      assert {:ok, %Post{} = post} = Timeline.create_post(valid_attrs)
      assert post.body == "some body"
      assert post.likes == "some likes"
    ...
    test "update_post/2 with valid data updates the post" do
      post = post_fixture()
      update_attrs = %{body: "some updated body", likes: "some updated likes", username: "some updated username"}

      assert {:ok, %Post{} = post} = Timeline.update_post(post, update_attrs)
      assert post.body == "some updated body"
      assert post.likes == "some updated likes"
